...
@app.route('/')
def hello_world():
    return render_template("/home/arnish/Arnish/work/DEV/vid_anonymisation/hci REVIEW/New folder/index.html")
...
def show():
    ...
    face_cascade = cv2.CascadeClassifier(
        "/home/arnish/Arnish/work/DEV/vid_anonymisation/hci REVIEW/templates/haarcascade_frontalface_default.xml")
